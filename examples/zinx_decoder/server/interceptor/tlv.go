...
type TLVInterceptor struct {
}

func (this *TLVInterceptor) GetDecoder() ziface.Interceptor {
	return zcode.NewLengthFieldFrameInterceptor(math.MaxUint32+8, 4, 4, 0, 0)
}

func (this *TLVInterceptor) Intercept(chain ziface.Chain) ziface.Response {
